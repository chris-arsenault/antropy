...
function metricRows(status: LiveStatus) {
  ...
  return [
    ...
    ["Overhead film material", s.coverMaterial.toFixed(3)],
    ...
    ["Emission paid · lifetime", l.flows.emission.toFixed(3)],
    ["Optical work captured · lifetime", l.opticalCaptured.toFixed(3)],
    ["Optical loss · lifetime", l.opticalHeat.toFixed(3)],
