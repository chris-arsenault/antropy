...
[rebuild results](docs/design/chemistry/rebuild-results.md#september15-correction-active-chemistry-and-restored-spatial-resolution).
...
Current implementation law: [composed runtime](docs/design/chemistry/composed-runtime.md).
...
evidence in [rebuild results](docs/design/chemistry/rebuild-results.md), ledger3818–3852.
...
are recorded in [rebuild results](docs/design/chemistry/rebuild-results.md).
...
[rebuild results](docs/design/chemistry/rebuild-results.md#browser-handoff-checks).
...
The [previous plan](docs/sources/history/digital-chemistry-plan-before-core-removal.md)
...
The governing [principles](docs/principles.md) and
[worker ownership contract](docs/design/chemistry/data-ownership.md) remain requirements.
...
[ADR 0022](docs/adr/0022-computable-chemistry.md); select formulas and cost together.
