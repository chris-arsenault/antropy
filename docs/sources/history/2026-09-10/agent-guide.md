...
The September 10 [strategic ecology](docs/design/strategic-ecology.md), plan
`c8d33225-63e2-4e48-960e-4ed88bbe4a87`, adds finite A/B deposits, toxin, damage/defense/repair,
matrix and decomposition. Current checkpoints are v5. Seed/fertilize and environmental developmental reaction norms remain
...
Implemented systems must visibly affect the ordinary Run population before review, or have an
explicit recorded reason to be disabled there. Running code and accumulating secretion counters
are insufficient. Default solid walls and neutral signaling are disabled; porous matrix remains.
