...
The authored nest, world carriers, and bounded body mechanics remain delivered. The programmed
food-loop repair now completes ordered surface food trips and cache retrieval across the measured
world panel. Appendix H level 0 plus evidenced level-1 search repairs replaced the universal moving
circle with stateless persistent search, shared contact deflection, and full-gradient differential
taxis. Human trajectory review remains. The old trained RNN cohort is still invalid because it
learned the incomplete policy and was judged by a recorder that could accept underground pickup as
a round trip.
...
|     3 | Implemented; review pending                  | Review the repaired programmed policy after ordered physical food trips and cache retrieval passed the measured varied-start panels                                                                                                     | ENV-03–05, CTRL-13, EXP-05       |
|     4 | Backlog, reopened                            | Distill balanced independent frames from the reviewed stateless programmed policy, then repeat cohort and robustness evaluation                                                                                                         | CTRL-06, EXP-06–07, BIO-01–02    |
|     5 | Delivered mechanism; recertification pending | Rerun the untreated colony resilience curve from the repaired controller base                                                                                                                                                           | BIO-03, EXP-08                   |
...
|     7 | Delivered mechanism; recertification pending | Recheck mortality and queen upkeep alone across varied worlds                                                                                                                                                                           | BIO-07, EXP-09                   |
|     8 | Backlog                                      | Demonstrate that physical caching extends survival through an imposed food gap                                                                                                                                                          | BIO-08, EXP-09                   |
|     9 | Delivered mechanism; recertification pending | Recheck worker reproduction; keep brood transport isolated unless replacement requires it                                                                                                                                               | BIO-09–11                        |
|    10 | Delivered mechanism; recertification pending | Recheck larval rearing and edible brood; keep microclimate and exposure isolated                                                                                                                                                        | BIO-12–13, ENV-07                |
|    11 | Delivered mechanism; recertification pending | Re-establish demographic continuity from physical gathering through matured-worker replacement                                                                                                                                          | BIO-14, EXP-09, ADV-02           |
