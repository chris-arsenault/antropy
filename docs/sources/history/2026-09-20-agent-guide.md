...
> Superseded September20 snapshot. Follow the [current design](../../design/README.md).
...
Current mathematical direction: the [transformation algebra white paper](../../design/chemistry/transformation-algebra.md)
...
The [enzyme correction and omission audit](../../symmetry-completion-audit.md) retains prior evidence.
Use the single [canonical mathematical plan](../../plans/archive/MATHEMATICAL-SYMMETRY-PLAN.md#regenerative-ecosystem-implementation),
...
Keep environmental plans separate. The [viewport UI pass](../../plans/archive/UI-OBSERVATION-PLAN.md) reorganizes
...
[hypothesis log](../../hypothesis-log.md); future phenotype legibility belongs in the UI work.

## Read first

| Topic                  | Link                                                                             |
| ---------------------- | -------------------------------------------------------------------------------- |
| Governing principles   | [docs/principles.md](../../principles.md)                                         |
| Current work order     | [docs/design/README.md](../../design/README.md)                                   |
| Current runtime contract | [docs/design/bacteria.md](../../design/bacteria.md) |
| Current evolutionary contract | [docs/design/funded-bodies.md](../../design/funded-bodies.md) |
| Current measurements | [Environmental evidence](../../design/chemistry/environmental-results.md), [rebuild evidence](../../design/chemistry/rebuild-results.md) |
| Historical ant certification | [docs/certifications.md](../../certifications.md) |
| Documentation index    | [docs/README.md](../../README.md)                                                 |
| Source archive         | [docs/sources/README.md](../README.md)                                 |
...
**Local illumination, September 19, 2026.** Physical v30 composes the shared external-work
responses as `1+c*cos(a)*cos(b-m)` and `1+c*cos(b)*cos(a-m)`, using the existing material-response
basis. Defaults: contrast0.8 and6,000/18,000/62,000model seconds. The v29 additive display
canceled its mixed term and swept too rapidly; the composed mean retains all three phases.
Cells, field and reservoirs use `diag(l0,l1) B`; abiotic kinetic rates still use B.
No new forces, material maps, resource
renewal rules or controller inputs. The [illumination plan](../../plans/archive/ENVIRONMENTAL-ECOLOGY-PLAN.md#local-illumination)
owns short opportunity, cost and review evidence. Separable Rust caches and borrowed worker
rendering preserve ownership; old physical checkpoints are rejected. Periodic forcing is
not proof of chaotic ecology or sustained specialization.
...
[binding plan](../../design/resource-binding-proposal.md) owns bounded results and remaining
...
battery. The [current runtime](../../design/chemistry/composed-runtime.md) and canonical R0–R4
...
[canonical results](../../plans/archive/MATHEMATICAL-SYMMETRY-PLAN.md#a4-results) measure startup376ticks/s and
...
The [omission audit](../../symmetry-completion-audit.md) owns validation and remaining limitations.
...
resolution or observation ownership changed. The [plan](../../plans/archive/MATHEMATICAL-SYMMETRY-PLAN.md) owns
...
Assembly/repair pay work without chemical conversion. The [bound-material record](../../bound-material.md)
...
velocity effort. Empty slots do not delay paid refitting. The [correction record](../../physical-coupling-correction.md)
...
The [weathering expansion](../../plans/archive/ENVIRONMENTAL-ECOLOGY-PLAN.md#weathering-redesign) records causal
...
The [current runtime](../../design/chemistry/composed-runtime.md) specifies these rules;
the [correction plan](../../plans/archive/ENVIRONMENTAL-ECOLOGY-PLAN.md#ecology-correction) records verification.
Earlier v14–v16 measurements below retain their original meaning. Human review remains pending.

**Mobile reservoirs, September 16, 2026.** The [source plan](../../plans/archive/MOBILE-SOURCES-PLAN.md) adds
...
1,500-tick comparisons and bounded confirmations. [Source evidence](../../design/chemistry/mobile-source-results.md)
...
[environmental plan](../../plans/archive/ENVIRONMENTAL-ECOLOGY-PLAN.md) adds smooth geographic weathering,
...
remain. The [environmental record](../../design/chemistry/environmental-results.md) contains
...
[rebuild work order](../../plans/archive/DIGITAL-CHEMISTRY-PLAN.md) supersede the numerical formulas,
...
the [follow-up repair](../../plans/archive/LONG-RUN-RELIABILITY-PLAN.md) addresses reproduced React development
...
[Computable chemistry](../../design/chemistry/computational-foundation.md) and
[ADR 0022](../../adr/0022-computable-chemistry.md) govern the current redesign. Design artificial
...
The implemented starting hypothesis is [sparse spatial ecology](../../design/spatial-ecology.md): a genuinely
...
sequence records implementation and its human review gate; [plan closeout](../../design/plan-closeout.md) and the
[backlog](../../backlog.md#backlog-plan-carryover) own disposition of earlier unfinished work.

The [current design](../../design/README.md) governs top-down bacteria with heritable local RNNs.
The active contract is 44 inputs, 24 recurrent units, nine outputs, sixteen funded stocks,
four chemical receptors/transporters/unary enzymes each, one photoreceptor, a membrane coordinate
and physical checkpoint v32. [Material-supported habitats](../../material-habitats.md) use shared
two-scale attraction, reversible material retention, locally evolving replenishment and eight
dyadic public transformations. Chemical 0 is an initial landscape choice, not a recurrent
supply or metabolic privilege. [Photoreception](../../photoreception.md) uses shared body/perimeter
sampling, funded gain and adaptation; it provides local mean brightness and change/directional
differences without sun coordinates or automatic steering. Its stock follows ordinary investment,
construction, upkeep, mutation and inheritance. New founder light weights start at zero.
[Digital chemistry](../../design/chemistry/README.md) replaces A/B processing, named toxins,
...
48 unequal mobile renewing reservoirs and two colonies. New [measurements](../../design/chemistry/rebuild-results.md)
contain constructed opportunities and negative findings, not evolved-community certification.
Historical A/B studies and their [corrected analysis](../../analysis-correction.md) retain their
...
multiple-substrate reactions and variable genome structure remain deferred.
Retired chemistry flags and checkpoints must fail explicitly; do not preserve a second economy.
The [runtime numerical record](../../design/chemistry/numerical-engine.md) and
[migration dispositions](../../design/chemistry/numerical-migration.md) describe the sole Rust/WASM
...
Automatic recovery retains up to six automatic and two manual compressed IndexedDB saves, within 256 MiB.
The newest save takes priority; older points expire to fit the byte budget, preferring manual points.
...
See [continuing observation](../../continuing-observation.md) for measurements and remaining browser
...
The [documentation snapshot](README.md) preserves prior contracts and full
...
[Numerical probes](../../design/chemistry/numerical-results.md) establish supplied
...
[resource-economy command and derivation](../../design/chemistry/resource-economy.md) calculate
...
The [current work order](../../design/README.md) supersedes earlier coexistence gates and roadmap
...
The earlier [registration and results](../../quick-food-access-study.md) remain historical; new
...
The six-area [capability study](../../capability-investigation.md) extends the same runner with
...
must not become new chemical evidence. The [work order](../../design/README.md) governs current work.
...
- The [data-sharing contract](../../design/chemistry/data-ownership.md) is immutable without an
...
- Measurements outrank plans and historical appendices. Documents under
  [docs/sources/](../README.md) preserve provenance and rejected work; they do not govern
