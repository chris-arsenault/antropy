...
The immutable [ownership contract](docs/design/chemistry/data-ownership.md) remains governing.
...
[cost report](docs/evidence/digital-chemistry/chemical-web-cost.json) retains every sample,
...
The [browser result](docs/evidence/digital-chemistry/chemical-web-ui.json) records bounds and
