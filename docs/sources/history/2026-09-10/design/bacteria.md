...
September 10: [strategic ecology](strategic-ecology.md) supersedes the single-food, source,
sensor/action and mortality details below. The current world includes two substrates, finite
deposits, toxin, defense/repair, porous matrix and decomposition, with a 35×24×8 RNN and v5
checkpoints. The original conversion record remains below for provenance.
