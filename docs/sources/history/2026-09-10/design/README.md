...
Current correction: plan `e04af0f4-38dd-4a84-acd5-989bf2c22b0e` addresses the rejected default
handoff. Implemented mechanisms must have visible consequences in Run or an explicit reason to
disable them. Solid walls and neutral signaling are now disabled by default; porous matrix and
toxin injury are assessed through matched default-world ablations.

Current implementation: [strategic microbial ecology](strategic-ecology.md), plan
`c8d33225-63e2-4e48-960e-4ed88bbe4a87`, approved September 10. Finite heterogeneous deposits,
two processing pathways, toxin/defense/repair, porous matrix and decomposition create competing
ecological opportunities. The local RNN contract is 35 inputs, 24 hidden units and eight outputs;
checkpoint v5 preserves the expanded state. Causal comparisons precede claims of spontaneous
adaptation. This supersedes the single-food runtime details below.

Completed evolutionary study: [founder advantage and inherited adaptation](evolution-attribution.md),
plan `ea5aa160-3b74-4728-b117-4959140c919f`. The user's browser reached generation 13 at tick 30,507;
founder dominance remains ambiguous. Inherited-target distributions and founder histories are
implemented. Eight long-run controls show mutation-linked concentration; the eight swapped-position
comparisons do not establish a transferable advantage for the predeclared representative descendant.

Current presentation work: [single-world bacterial display](bacterial-display.md), plan
`2e635021-b24d-4730-9a6b-257e26f15c9d`. Bounded camera navigation, body/resource cues and visible
population history improve observation of the existing model without changing simulation mechanics.
